...
class MiniMaxH3DirectorConditioningWH:
    """Thin wrapper around official MiniMax H3 conditioning (positive + latent).

    宽高输入变体（WH 后缀），避免与原版 ComfyUI_MiniMaxH3_Director 节点冲突。
    """
...
class MiniMaxH3DirectorPlannerConditioningWH:
    ...
    @classmethod
    def INPUT_TYPES(cls):
        base = MiniMaxH3DirectorConditioningWH.INPUT_TYPES()
        return base
